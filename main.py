...
st.title('Screen Resolution Bar Graph')
...
screen_resolution = df['Screen Resolution'].value_counts()
screen_resolution
...
data = {
    ...
    'Count': [505, 263, 226, 51, 47, 23, 16, 15, 12, 11, 10, 7, 7, 7, 6, 6, 6, 5, 4, 4, 4, 4, 4, 3, 3, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 1, 1, 1, 1, 1]
}
...
plt.barh(df['ScreenResolution'], df['Count'], color = 'skyblue')
plt.xlabel('Count')
plt.ylabel('ScreenResolution')
plt.title('ScreenResolution Distribution in Laptops')
